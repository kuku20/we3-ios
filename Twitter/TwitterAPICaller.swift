...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "UC8bMnWCZqkzzKVt03WPXQwEM", consumerSecret: "i22hGM94QYgnLqQ3pTCsexfJkL5jRDxMZ4PG6d2VKu6S4Inunh")
    var loginSuccess: (() -> ())?
